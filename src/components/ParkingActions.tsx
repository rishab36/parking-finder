    ...
    <div className="mb-6 space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <ActionButton 
          ...
          isLoading={isLoading}
          variant={mapClickMode === 'update' ? "primary" : "secondary"}
          icon={mapClickMode === 'update' 
            ? <LocateFixed className="h-5 w-5 text-red-500 animate-pulse" /> 
            : <MapPin className="h-5 w-5 transition-all group-hover:scale-110 group-hover:text-red-500 duration-300" />
          }
